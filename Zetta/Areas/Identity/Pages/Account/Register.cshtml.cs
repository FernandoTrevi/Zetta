...
namespace Zetta.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                //var user = CreateUser(); vamos a usar la clase UsuarioAplicación
                ...
                if (result.Succeeded)//si el usuario se creó exitosamente
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Confirmar tu Email",
                        $"Por favor, confirmá tu cuanta <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>Click aquí</a>.");
